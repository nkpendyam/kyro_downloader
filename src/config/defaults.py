...
DEFAULT_CONFIG = {
    ...
    "download": {"max_retries": 3, "retry_delay": 2.0, "retry_backoff": "exponential", "concurrent_workers": 3, "rate_limit": None, "proxy": None, "cookies_file": None, "timeout": 300, "fragment_retries": 10, "concurrent_fragment_downloads": 4},
    ...
    "web": {"host": "127.0.0.1", "port": 8000, "debug": False, "cors_origins": []},
}
