...
class SubscriptionManager:
    ...
    def subscribe(self, channel_url, auto_download=False, quality="best", output_path=None):
        sub = {
            "url": channel_url,
    ...
    def unsubscribe(self, channel_url):
    ...
    def update_last_check(self, channel_url, last_video=None):
